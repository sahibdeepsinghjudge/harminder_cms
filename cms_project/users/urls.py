...
from .views import home, create_partner, login_view,create_customer,search_user,clients,new_connection_request,new_conn_dash,technicians_dash,create_technician
